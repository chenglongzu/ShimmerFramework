...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.AddPreLoad("CharacterController", LuaOpen_CharacterController, typeof(CharacterController));
	...
	static int LuaOpen_CharacterController(IntPtr L)
	{
		try
		{
			...
			int reference = state.GetMetaReference(typeof(CharacterController));
			state.EndPreModule(L, reference);
			return 1;
		}
		catch(Exception e)
