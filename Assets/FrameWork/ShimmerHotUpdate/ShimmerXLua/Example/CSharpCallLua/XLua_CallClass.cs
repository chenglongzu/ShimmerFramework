...
public class XLua_CallClass : MonoBehaviour
{
    void Start()
    {
        ...
        XLuaCallLuaClass obj = XLuaManager.GetInstance().Global.Get<XLuaCallLuaClass>("testClas");
        ...
        obj.testInt = 100;
        XLuaCallLuaClass obj2 = XLuaManager.GetInstance().Global.Get<XLuaCallLuaClass>("testClas");
